...
# Sysclk is a 25 MHz PL reference clock generated by the external Ethernet PHY
...
set_property -dict { PACKAGE_PIN E12 IOSTANDARD LVCMOS18 } [get_ports {clk25mhz}];
create_clock -period 40.000 -name sys_clk_pin -waveform {0.000 20.000} -add [get_ports clk25mhz]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets clk25mhz]
...
set_property -dict { PACKAGE_PIN G10  IOSTANDARD LVCMOS18 } [get_ports { auto_vadj}]; #IO_L3N_AD13N_45/25 Sch=vadj_auton
...
## Buttons
set_property -dict { PACKAGE_PIN B10  IOSTANDARD LVCMOS18 } [get_ports { btn }]; #IO_L9N_AD11N_45/25 Sch=btn[2]
...
## LED
set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports { led[0] }]; #IO_L12P_AD0P_46/26 Sch=ld[1]
set_property -dict { PACKAGE_PIN L13   IOSTANDARD LVCMOS33 } [get_ports { led[1] }]; #IO_L12N_AD0N_46/26 Sch=ld[2]
set_property -dict { PACKAGE_PIN K14   IOSTANDARD LVCMOS33 } [get_ports { led[2] }]; #IO_L11P_AD1P_46/26 Sch=ld[3]
set_property -dict { PACKAGE_PIN J14   IOSTANDARD LVCMOS33 } [get_ports { led[3] }]; #IO_L11N_AD1N_46/26 Sch=ld[4]
...
## SYZYGY
set_property -dict {PACKAGE_PIN Y8 IOSTANDARD LVDS} [get_ports o_adc_clkout_n];#IO_L14N_T2_SRCC Sch=syzygy_c2p_clk_n
set_property -dict {PACKAGE_PIN W8 IOSTANDARD LVDS} [get_ports o_adc_clkout_p];#IO_L14P_T2_SRCC Sch=syzygy_c2p_clk_p
set_property -dict {PACKAGE_PIN AC1 IOSTANDARD LVCMOS18} [get_ports o_zmod_adc_coupling_l_a];#IO_L21N_T3_DQS Sch=syzygy_d_n[0]
set_property -dict {PACKAGE_PIN AB1 IOSTANDARD LVCMOS18} [get_ports o_zmod_adc_coupling_h_a];#IO_L21P_T3_DQS Sch=syzygy_d_p[0]
set_property -dict {PACKAGE_PIN AF2 IOSTANDARD LVCMOS18} [get_ports o_zmod_adc_coupling_l_b];#IO_L20N_T3 Sch=syzygy_d_n[1]
set_property -dict {PACKAGE_PIN AE2 IOSTANDARD LVCMOS18} [get_ports o_zmod_adc_coupling_h_b];#IO_L20P_T3 Sch=syzygy_d_p[1]
set_property -dict {PACKAGE_PIN AF3 IOSTANDARD LVCMOS18} [get_ports or_adc_sck];#IO_L23N_T3 Sch=syzygy_d_n[2]
set_property -dict {PACKAGE_PIN AE3 IOSTANDARD LVCMOS18} [get_ports o_adc_sdio];#IO_L23P_T3 Sch=syzygy_d_p[2]
set_property -dict {PACKAGE_PIN AF5 IOSTANDARD LVCMOS18} [get_ports o_zmod_adc_gain_l_b];#IO_L24N_T3 Sch=syzygy_d_n[3]
set_property -dict {PACKAGE_PIN AE5 IOSTANDARD LVCMOS18} [get_ports o_zmod_adc_gain_h_b];#IO_L24P_T3 Sch=syzygy_d_p[3]
set_property -dict {PACKAGE_PIN AE7 IOSTANDARD LVCMOS18} [get_ports {i14_adc_data[2]}];#IO_L22N_T3 Sch=syzygy_d_n[4]
set_property -dict {PACKAGE_PIN AD7 IOSTANDARD LVCMOS18} [get_ports {i14_adc_data[9]}];#IO_L22P_T3 Sch=syzygy_d_p[4]
set_property -dict {PACKAGE_PIN AG5 IOSTANDARD LVCMOS18} [get_ports o_zmod_adc_gain_l_a];#IO_L19N_T3_VREF Sch=syzygy_d_n[5]
set_property -dict {PACKAGE_PIN AG6 IOSTANDARD LVCMOS18} [get_ports o_zmod_adc_gain_h_a];#IO_L19P_T3 Sch=syzygy_d_p[5]
set_property -dict {PACKAGE_PIN V8 IOSTANDARD LVCMOS18} [get_ports {i14_adc_data[4]}];#IO_L7N_T1 Sch=syzygy_d_n[6]
set_property -dict {PACKAGE_PIN U8 IOSTANDARD LVCMOS18} [get_ports {i14_adc_data[3]}];#IO_L7P_T1 Sch=syzygy_d_p[6]
set_property -dict {PACKAGE_PIN V9 IOSTANDARD LVCMOS18} [get_ports o_zmod_adc_com_l];#IO_L9N_T1_DQS Sch=syzygy_d_n[7]
set_property -dict {PACKAGE_PIN U9 IOSTANDARD LVCMOS18} [get_ports o_zmod_adc_com_h];#IO_L9P_T1_DQS Sch=syzygy_d_p[7]
#set_property -dict { PACKAGE_PIN AD4 IOSTANDARD LVCMOS18} [get_ports { }]; #IO_L13N_T2_MRCC Sch=syzygy_p2c_clk_n#IO_L13N_T2_MRCC Sch=syzygy_p2c_clk_n
set_property -dict {PACKAGE_PIN AD5 IOSTANDARD LVCMOS18} [get_ports i_adc_dco];#IO_L13P_T2_MRCC Sch=syzygy_p2c_clk_p
set_property -dict {PACKAGE_PIN AE10 IOSTANDARD LVCMOS18} [get_ports {i14_adc_data[5]}];#IO_L12N_T1_MRCC Sch=syzygy_s[16]
set_property -dict {PACKAGE_PIN AC12 IOSTANDARD LVCMOS18} [get_ports {i14_adc_data[8]}];#IO_L11N_T1_SRCC Sch=syzygy_s[17]
set_property -dict {PACKAGE_PIN AF10 IOSTANDARD LVCMOS18} [get_ports {i14_adc_data[6]}];#IO_L12P_T1_MRCC Sch=syzygy_s[18]
set_property -dict {PACKAGE_PIN AD12 IOSTANDARD LVCMOS18} [get_ports {i14_adc_data[10]}];#IO_L11P_T1_SRCC Sch=syzygy_s[19]
set_property -dict {PACKAGE_PIN AF11 IOSTANDARD LVCMOS18} [get_ports {i14_adc_data[7]}];#IO_L10N_T1 Sch=syzygy_s[20]
set_property -dict {PACKAGE_PIN AE12 IOSTANDARD LVCMOS18} [get_ports {i14_adc_data[11]}];#IO_L8N_T1 Sch=syzygy_s[21]
set_property -dict {PACKAGE_PIN AF12 IOSTANDARD LVCMOS18} [get_ports {i14_adc_data[1]}];#IO_L10P_T1 Sch=syzygy_s[22]
set_property -dict {PACKAGE_PIN AH12 IOSTANDARD LVCMOS18} [get_ports {i14_adc_data[12]}];#IO_L8P_T1 Sch=syzygy_s[23]
set_property -dict {PACKAGE_PIN AG11 IOSTANDARD LVCMOS18} [get_ports {i14_adc_data[0]}];#IO_L15N_T2_DQS Sch=syzygy_s[24]
set_property -dict {PACKAGE_PIN AG10 IOSTANDARD LVCMOS18} [get_ports {i14_adc_data[13]}];#IO_L15P_T2_DQS Sch=syzygy_s[25]
set_property -dict {PACKAGE_PIN AH11 IOSTANDARD LVCMOS18} [get_ports o_adc_cs];#IO_L16N_T2 Sch=syzygy_s[26]
set_property -dict {PACKAGE_PIN AH10 IOSTANDARD LVCMOS18} [get_ports o_adc_sync];#IO_L16P_T2 Sch=syzygy_s[27]

...
set projectName genesys_goertzel_rtu
...
add_file [glob ../src/vadj_set_genesys_v1_0.v]
add_file [glob ../src/obufds_inst.v]
add_file [glob ../src/zmod_adc_driver_v1_1.v]

## Adding constraints files
read_xdc ../xdc/genesyszu_zmod.xdc
...
source ./bd/genesys_goertzel_rtu.tcl
